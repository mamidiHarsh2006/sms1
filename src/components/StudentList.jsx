...
function StudentList() {
  ...
  const fetchStudents = async () => {
    const res = await axios.get('https://sms-uagq.onrender.com/students');
    setStudents(res.data);
  };

  const deleteStudent = async (id) => {
    await axios.delete(`https://sms-uagq.onrender.com/students/${id}`);
    fetchStudents();
  };
  ...
  <div className="table-responsive shadow table-wrapper">
